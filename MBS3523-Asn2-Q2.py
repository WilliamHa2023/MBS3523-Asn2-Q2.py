...
# You need to download the weights and yolov3-320.cfg files from https://pjreddie.com/darknet/yolo/
net = cv2.dnn.readNetFromDarknet('yolov3-320.yolov3-320.cfg','yolov3-320.weights')
